...
--
-- Host: localhost
-- Generation Time: Jan 18, 2016 at 07:51 AM
...
--
-- Table structure for table `afile_file_upload`
--

CREATE TABLE `afile_file_upload` (
  `id` int(11) NOT NULL,
  `cdate` date NOT NULL,
...
--
-- Dumping data for table `afile_file_upload`
--

INSERT INTO `afile_file_upload` (`id`, `cdate`, `pdf`, `current_time`) VALUES
(1, '2016-01-07', 'PDF8.pdf', '2016-01-18 06:06:10'),
(2, '2016-01-14', 'PDF9.pdf', '2016-01-18 06:07:18'),
(5, '2016-01-04', 'This_is_a_test_PDF_file8.pdf', '2016-01-18 06:16:52');
...
(5, 'File_upload', '', '', 'site/viewfile_upload', 1, 0, 1, 2, 'icon-dashboard'),
...
--
-- Indexes for table `afile_file_upload`
--
ALTER TABLE `afile_file_upload`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `afile_file_upload`
--
ALTER TABLE `afile_file_upload`
